...
LRRH is a [BadWolf](https://hacktivis.me/projects/badwolf) derived browser with different keybindings, middle mouse click to open hyperlinks on new tabs and Gemini/Gopher protocol support (trough external aplications).
